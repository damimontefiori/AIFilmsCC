...
export async function refineConcept(
  ...
  const user = [
    ...
    "- NARRABLE EN PANTALLA: el deseo, las apuestas y el giro deben poder MOSTRARSE con acción y diálogo en la duración dada, sin depender de backstory que el espectador no pueda ver. Evita premisas que exijan explicar mucho pasado o mundo interior no visualizable; el conflicto ocurre AQUÍ y AHORA, ante la cámara.",
    "",
    ...
    "- synopsis: 4-6 frases con arco real que se pueda DRAMATIZAR en pantalla: planteamiento, escalada, giro y desenlace resonante.",
